...
function Icon({ children, size = 18, stroke = 1.75, style, ...props }) {
  return (
...
const P = (d) => (props) => <Icon {...props}><path d={d} /></Icon>;
...
const ListTree = (p) => <Icon {...p}><path d="M21 12h-8"/><path d="M21 6H8"/><path d="M21 18h-8"/><path d="M3 6v4c0 1.1.9 2 2 2h3"/><path d="M3 10v6c0 1.1.9 2 2 2h3"/></Icon>;
...
const Bell = (p) => <Icon {...p}><path d="M10.268 21a2 2 0 0 0 3.464 0"/><path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"/></Icon>;
...
const Trash = (p) => <Icon {...p}><path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m3 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M10 11v6M14 11v6"/></Icon>;
const Download = (p) => <Icon {...p}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="M7 10l5 5 5-5"/><path d="M12 15V3"/></Icon>;
const Filter = P("M22 3H2l8 9.46V19l4 2v-8.54L22 3z");
const X = P("M18 6 6 18M6 6l12 12");
const Check = P("M20 6 9 17l-5-5");
const PanelLeft = (p) => <Icon {...p}><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 3v18"/></Icon>;
const LogOut = (p) => <Icon {...p}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="M16 17l5-5-5-5"/><path d="M21 12H9"/></Icon>;
...
const Building = (p) => <Icon {...p}><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M9 22v-4h6v4M8 6h.01M16 6h.01M12 6h.01M12 10h.01M12 14h.01M16 10h.01M16 14h.01M8 10h.01M8 14h.01"/></Icon>;

Object.assign(window, {
  Icon, LayoutDashboard, Users, ShieldCheck, ListTree, Database, ScrollText,
  Search, Bell, Sun, Moon, ChevronDown, ChevronRight, Plus, Pencil, Trash,
  Download, Filter, X, Check, PanelLeft, LogOut, Settings, MoreHorizontal,
  Lock, User, RefreshCw, KeyRound, Building,
});
